...
This annotated Quarto file is attached as supplementary material for the tutorial manuscript, which can be downloaded from our [Github repository](https://github.com/rameliaz/grm-tutorial-paper).
